...
<form action="<?php echo JRoute::_('index.php?option=com_listing&layout=edit&id='.(int) $this->item->id); ?>"
 ...
 <div class="width-60 fltlft">     
	<fieldset class="adminform">
		...
		$userdetails = "select u.id as user_id, u.name, u.email, u.block, uh.total_balance, uh.line_of_credit, uh.status from ";
						...
						<tr>
							...
							<td>
								<select name="user_status">
									<option value="1" <?php if($user_detail['status']== '1') echo 'selected="selected"';?>>Inactive</option>
									<option value="0" <?php if($user_detail['status']== '0') echo 'selected="selected"';?>>Active</option>
								</select>
							</td>
						</tr>
					</tbody>
	...
	<div>
		...
		<input type="hidden" name="hs_user_id" value="<?php echo $user_id; ?>" />
