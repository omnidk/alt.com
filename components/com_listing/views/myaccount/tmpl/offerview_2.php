						...
						<table border="0" width="40%">
							...
							<tr>
								...
								<td>
									...
									<a href="index.php?option=com_listing&view=myaccount&layout=accept&offer_id=<?php echo $rows['id']; ?>">Accept</a>



									| <a href="index.php?option=com_listing&view=myaccount&layout=reject&offer_id=<?php echo $rows['id']; ?>">Reject</a>
