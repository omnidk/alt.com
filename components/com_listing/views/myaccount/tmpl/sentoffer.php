...
<?php
  $user =& JFactory::getUser();
	...
	$db->setQuery("SELECT lo.id as id,
				   ...
				   WHERE lo.offered_by = $user_id AND lo.is_archived_by_seller = 0 AND lo.is_parent = 0 AND lo.type = 1");
...
$db->setQuery("SELECT lo.id as id,
				   ...
				   WHERE lo.offered_by = $user_id AND lo.is_archived_by_seller = 0 AND lo.type = 2");
$rows = $db->loadObjectList();
	?>
