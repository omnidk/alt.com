 ...
 $user =& JFactory::getUser();
	...
	if($user_id == 0)
	{
	 ...
	 //print_r($account_detail);
	  ...
	  <form action="index.php?option=com_listing&view=myaccount&layout=transcredit" method="post" name="adminForm" enctype="multipart/form-data">
	  ...
	  <td>
	  <input class="inputbox" type="text" name="comments" id="comments" size="40" value="" />
	  </td>
	  </tr>
	  <tr>
	  ...
	  <td>
	  <input type="submit" name="submit" value="Submit" onclick="return confirm('are you sure you want to transfer ?');">
	  </td>
	  </tr>
	  </tbody>
	  </table>
