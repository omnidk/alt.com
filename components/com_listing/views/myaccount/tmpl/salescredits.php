...
<?php
   $user =& JFactory::getUser();
	...
	$db->setQuery("SELECT lo.id as id,
				   ...
				   WHERE lo.offered_to = $user_id AND lo.status = 'accepted'
	...
	<div class="listing">
		...
		<thead>                            
			<tr style="background-color:#CCCCCC;">
						...
						<th scope="col"><a href="index.php?option=com_listing&view=myaccount&layout=salescredits&order_by=<?php echo $order_by1; ?>">Date & Time</a></th>
