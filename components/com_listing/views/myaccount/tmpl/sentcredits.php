...
<?php
   $user =& JFactory::getUser();
	...
	$db->setQuery("SELECT th.id as id,
                        ...
                        th.receiver_id as receiver_id,
                          th.comments as comments,
                         th.created_date as created_date,
					  u.name as seller_name
               FROM #__barter_users_transfer_history th
			   INNER JOIN #__users u ON u.id = th.receiver_id
			   WHERE th.sender_id = $user_id
	...
	<div class="right">
		...
		<thead>                            
			<tr style="background-color:#CCCCCC;">
						...
						<th scope="col"><a href="index.php?option=com_listing&view=myaccount&layout=sentcredits&order_by=<?php echo $order_by1; ?>">Date & Time</a></th>
						<th scope="col">To</th>
