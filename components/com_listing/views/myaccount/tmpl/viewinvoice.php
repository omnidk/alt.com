		...
		?>
				...
				<thead>                            
					...
					<tr>
						...
						<th nowrap="nowrap" class="title"><a href="index.php?option=com_listing&view=myaccount&layout=sentcredits&order_by=<?php echo $user_id; ?>" style="float:left;">Date and Time</a></th>
        		...
        		$database->setQuery("SELECT * FROM #__barter_users_transfer_history");
...
<form action="index.php?option=com_listing&view=myaccount&layout=payinvoice" method="post" name="adminForm" enctype="multipart/form-data">
<input type="hidden" name="invoiceID" value="<?php echo $invoiceID; ?>" />
<input type="hidden" name="amt" value="<?php echo $invoice->amt; ?>" />
