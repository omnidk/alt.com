...
class paypal_class 
{
   ...
   {
	 	$this->paypal_email = "omni@sitebuilderstudio.com";
   ...
   function submit_paypal_post_2() 
   {
      ...
      // is redirected to paypal. <h3>Please wait, your reservation is being processed...</h3>
		...
		echo "<div style='float:left; margin: 0px;'><a href='index.php'><span class='button'> << Pay Later </span></a></div>";
		echo "<div style='float:right; margin: 0px;'><input class='button' type='submit' name='submit' value='Pay With Paypal >>' /></div>";
...
/*<img src='http://".$_SERVER['HTTP_HOST']."/".substr(JPATH_SITE,19,20)."/components/".COMPONENT."/images/loader.gif"."' >*/
		echo " <h3>Please Wait, Your Transaction Is Being Processed...</h3>";
      echo "<html>\n";
      echo "<head><title>Processing Payment...</title></head>\n";
