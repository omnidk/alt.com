...
var path= self.location.hostname+self.location.pathname;
	var L = path.length;
	var test= path.substr(0,L-11);
var imageFilesPath = "http://"+test+'r/components/com_virtuemart/';

	/*var tes= path.split('/', 1);
	var tes1=tes[0].+"/"+test[1]+"/"+tes[2];
	alert(tes1);*/
...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader = "<table style='background-color:"+CalBgColor+";width:200px;padding:0;margin:5px auto 5px auto;line-height:11px;'><tbody>";
	...
	funcCalback += " var CalId = document.getElementById(id);if (datum=== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;CalId.value=datum;donatiomade(CalId.value);";
