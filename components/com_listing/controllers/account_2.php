...
class  ListingControllerAccount extends JController
{
	...
	{  
		...
		$row_update=$database->setQuery("update #__barter_account set comission_percent='$comission_percent',payment_title='$payment_title', default_user = '$user_default' where id=$account_id");
		$database->query();
